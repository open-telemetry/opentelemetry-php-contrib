# OpenTelemetry Symfony Instrumentation Bundle
...
return [
    // ...
    OpenTelemetry\Symfony\OtelInstrumentationBundle\OtelInstrumentationBundle::class => ['all' => true],
    // ...
];
````
...
- [minimal](/tests/Integration/Symfony/OtelInstrumentationBundle/DependencyInjection/config/minimal/config.yaml)
- [simple](/tests/Integration/Symfony/OtelInstrumentationBundle/DependencyInjection/config/simple/config.yaml)
- [resource](/tests/Integration/Symfony/OtelInstrumentationBundle/DependencyInjection/config/resource/config.yaml)
- [samplers](/tests/Integration/Symfony/OtelInstrumentationBundle/DependencyInjection/config/sampler/config.yaml)
- [span](/tests/Integration/Symfony/OtelInstrumentationBundle/DependencyInjection/config/span/config.yaml)
- [exporters](/tests/Integration/Symfony/OtelInstrumentationBundle/DependencyInjection/config/exporters/config.yaml)
- [full](/tests/Integration/Symfony/OtelInstrumentationBundle/DependencyInjection/config/full/config.yaml)
- [disabled](/tests/Integration/Symfony/OtelInstrumentationBundle/DependencyInjection/config/disabled/config.yaml)
