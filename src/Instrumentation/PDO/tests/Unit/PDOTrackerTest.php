        ...
        return [
            'standard format with host and port' => [
                ...
                [
                    ...
                    ServerAttributes::SERVER_PORT => 3306,
                    DbAttributes::DB_NAMESPACE => 'test',
                ],
            ],
            ...
            'PostgreSQL format' => [
                ...
                [
                    ServerAttributes::SERVER_ADDRESS => 'localhost',
                    ServerAttributes::SERVER_PORT => 5432,
                    DbAttributes::DB_NAMESPACE => 'test',
                ],
            ],
            'SQLite format' => [
                ...
                [
                    ...
                    DbAttributes::DB_NAMESPACE => '/path/to/database.sqlite',
                ],
            ],
            ...
            'Oracle format' => [
                ...
                [
                    ServerAttributes::SERVER_ADDRESS => 'localhost',
                    ServerAttributes::SERVER_PORT => 1521,
                    DbAttributes::DB_NAMESPACE => 'test',
                ],
            ],
            'SQL Server format' => [
                ...
                [
                    ServerAttributes::SERVER_ADDRESS => 'localhost',
                    ServerAttributes::SERVER_PORT => 1433,
                    DbAttributes::DB_NAMESPACE => 'test',
                ],
            ],
            ...
            'MySQL format with host in DSN prefix and port' => [
                ...
                [
                    ServerAttributes::SERVER_PORT => 3307,
                    DbAttributes::DB_NAMESPACE => 'test',
                ],
            ],
            'MySQL format with host in DSN prefix and colon port' => [
                ...
                [
                    ServerAttributes::SERVER_ADDRESS => '127.0.0.1',
                    ServerAttributes::SERVER_PORT => 3308,
                    DbAttributes::DB_NAMESPACE => 'test',
                ],
            ],
        ];
