...
namespace OpenTelemetry\Contrib\Resource\Detector\Apache;
...
final class Apache implements ResourceDetectorInterface
{
    public function getResource(): ResourceInfo
    {
        ...
        if (function_exists('apache_get_version')) {
            $attributes['webengine.name'] = 'apache'; //@todo add webengine.* to semconv
            $apacheFullVersion = apache_get_version();
            if ($apacheFullVersion !== false) {
                ...
                if ($versionNumber !== null) {
                    $attributes['webengine.version'] = $versionNumber;
                }

                // webengine.description should contain detailed version and edition information
                $attributes['webengine.description'] = $apacheFullVersion;
            }
        }
